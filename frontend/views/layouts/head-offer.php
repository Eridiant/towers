...
<div class="content">
    ...
    <div class="content-wrapper">
        <div class="content-nav">
            <ul>
                <li><a href="<?=Url::toRoute('/ru/') ?>">
                    <?=Yii::t('frontend', 'Главная')?>
                </a></li>
                <li><a href="<?=Url::toRoute('/ru/infrastructure') ?>">
                    <?=Yii::t('frontend', 'Инфраструктура')?>
                </a></li>
                <li><a href="<?=Url::toRoute('/ru/layouts') ?>">
                    <?=Yii::t('frontend', 'Планировки')?>
                </a></li>
                <li><a href="<?=Url::toRoute('/ru/gallery') ?>">
                    <?=Yii::t('frontend', 'Галерея')?>
                </a></li>
                <li><a href="<?=Url::toRoute('/ru/about') ?>">
                    <?=Yii::t('frontend', 'О компании')?>
                </a></li>
                <li><a href="<?=Url::toRoute('/ru/news') ?>">
                    <?=Yii::t('frontend', 'Новости')?>
                </a></li>
                <li><a href="<?=Url::toRoute('/ru/contacts') ?>">
                    <?=Yii::t('frontend', 'Контакты')?>
                </a></li>
            </ul>
        </div>
