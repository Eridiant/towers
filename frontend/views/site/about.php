        ...
        <div class="about-wrapper">
            <div class="about-desc">
                ...
                <div class="about-text">
                    <p>
                        <?=Yii::t('frontend', 'Проект «Calligraphy Towers» представляет собой жилой комплекс элитного типа состоящий из 3-х корпусов блок А,Б,С, сам комплекс расположен в благоустроенной части города на «Аллея-Героев».<br>
Клубный тип апартаментов и большой выбор инфраструктуры не оставляет шансов для бушующих жильцов.<br>
Проект «Calligraphy Towers» ориентирован на современных горожан, предпринимателей и фрилансеров, которые хотят работать и пользоваться всеми сервисами не выходя из дома. В доме есть подземный и уличный паркинг.<br>
В комплексе:<br>
На первых этажах будут расположены: магазины, рестораны, офисы, коворкинг, а также лаунж-зоны. В блоке А 10 этажей занимает отель «Хемптон» международной сети «Хилтон».<br>
Главное для покупателя «Calligraphy Towers» — это максимальная приватность, комфорт и высокий сервис обслуживания. На разных этажах комплекса вы найдете разный уровень от клубной квартиры в 150 кв, до студии 30 кв. Все апартаменты предлагаются покупателям с пред чистовой или с отделкой, под ключ» то есть с мебелью и техникой.')?>
                    </p>
                    <p>
                        <?=Yii::t('frontend', 'Инфраструктурная часть комплекса Calligraphy Towers включает:')?>
                    </p>
                    <ul>
                        ...
                        <?php endif; ?>
                        <?php if (Yii::t('frontend', 'парковочные места;') != 'null'): ?>
                            <li>
                                <?=Yii::t('frontend', 'парковочные места;')?>
                            </li>
                        <?php endif; ?>
