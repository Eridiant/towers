        ...
        <div class="about-wrapper">
            <div class="about-desc">
                ...
                <div class="about-text">
                    ...
                    <p>
                        <?=Yii::t('frontend', '<strong>В блоке А 10 этажей занимает международный сетевой отель «Hampton by Hilton» сети «Hilton worldwide», что придает стабильный интерес к комплексу у отдыхающих туристов.</strong><br>Ценности  «Calligraphy Towers» — это максимальная приватность,  комфорт и высокий сервис обслуживания.<br>В комплексе предусмотрены  разные уровни и размеры апартаментов, от клубной квартиры в 150 кв, до студии 28 кв.<br>Все апартаменты предлагаются покупателям с пред.чистовой  или с отделкой ,”под ключ” с мебелью и техникой.<br>Подробнее о проекте вы можете узнать оставив заявку на сайте или написав нам в чат, а также можно скачать нашу презентацию.')?>
                    </p>
                </div>
