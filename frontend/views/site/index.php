                ...
                <div class="swiper-slide">
                    <div class="infr-slider">
                        <div class="infr-img">
                            ...
                            <div>
                                <p>
                                    <strong><?=Yii::t('frontend', 'Казино')?></strong> <?=Yii::t('frontend', 'комплекс включает формат развлечений для лиц старше 21+, вас ждет казино и разнообразные игры в режиме 24 часа')?>
                                </p>
                            </div>
                        </div>
                        <div class="infr-title">
                ...
                <div class="swiper-slide">
                    <div class="infr-slider">
                        <div class="infr-img">
                            ...
                            <div>
                                <p>
                                    <strong><?=Yii::t('frontend', 'Фитнес')?></strong> <?=Yii::t('frontend', 'наша задача — создать все условия, чтобы спорт приносил не только пользу, но и удовольствие оснащенный новейшим спортивным оборудованием и всеми необходимыми тренажерами для профессионального спорта и любительских занятий')?>
                                </p>
                            </div>
                        </div>
                        <div class="infr-title">
                ...
                <div class="swiper-slide">
                    <div class="infr-slider">
                        <div class="infr-img">
                            ...
                            <div>
                                <p>
                                    <strong><?=Yii::t('frontend', 'Бизнес центр')?></strong> <?=Yii::t('frontend', 'отличное место для работы и отдыха, мы предусмотрели возможность работы в формате коворкинг зон для переговров и мероприятий.')?>
                                </p>
                            </div>
                        </div>
                        <div class="infr-title">
                ...
                <div class="swiper-slide">
                    <div class="infr-slider">
                        <div class="infr-img">
                            ...
                            <div>
                                <p>
                                    <strong><?=Yii::t('frontend', 'Рестораны')?></strong> <?=Yii::t('frontend', 'будут иметь свыше 3 видов кухни, приятная музыка, морской воздух. Высокая и традиционная Грузинская, Европейская, Азиатская кухня и кошерная.')?>
                                </p>
                            </div>
                        </div>
                        <div class="infr-title">
                ...
                <div class="swiper-slide">
                    <div class="infr-slider">
                        <div class="infr-img">
                            ...
                            <div>
                                <p>
                                    <strong><?=Yii::t('frontend', 'Детская комната')?></strong> <?=Yii::t('frontend', 'концепция отеля имеет детский клуб и анимацию для детей от 2 до 10 лет,  мы ценим ваш отдых и заботимся о ваших детях.')?>
                                </p>
                            </div>
                        </div>
                        <div class="infr-title">
                ...
                <div class="swiper-slide">
                    <div class="infr-slider">
                        <div class="infr-img">
                            ...
                            <div>
                                <p>
                                    <strong><?=Yii::t('frontend', 'Собственный пляж')?></strong> <?=Yii::t('frontend', 'ваш отдых будет иметь персональную зону на море, отдельный пляж и лежаки.')?>
                                </p>
                            </div>
                        </div>
                        <div class="infr-title">
                ...
                <div class="swiper-slide">
                    <div class="infr-slider">
                        <div class="infr-img">
                            ...
                            <div>
                                <p>
                                    <strong><?=Yii::t('frontend', 'Озелененные террасы')?></strong> <?=Yii::t('frontend', 'сможете насладиться видами вечернего Батуми , футбольным матчем или концертом мирового масштаба не покидая комплекс')?>
                                </p>
                            </div>
                        </div>
                        <div class="infr-title">
