    ...
    public function actionBot()
    {
        ...
        try {
            ...
            $result = Request::sendPhoto([
                'chat_id' => $chat_id,
                'caption' => "Здравствуйте\nКомпания «Гранд майзон» имеет своего бота который сможет вам помочь и узнать больше про проект «Калиграфи таурс».\nБот Калиграфи умеет:\n-отправлять информацию -организовывать консультации со специалистами\n-отправлять нужную для вас информацию.\nБольшое спасибо за обрушение, команда калиграфи таурс.",
