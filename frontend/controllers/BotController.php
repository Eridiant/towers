    ...
    public function actionBot()
    {
        ...
        try {
            ...
            $result = Request::sendPhoto([
                'chat_id' => $chat_id,
                'caption' => 'Здравствуйте%0AКомпания «Гранд майзон» имеет своего бота который сможет вам помочь и узнать больше про проект «Калиграфи таурс».%0AБот Калиграфи умеет:%0A-отправлять информацию -организовывать консультации со специалистами%0A-отправлять нужную для вас информацию.%0AБольшое спасибо за обрушение, команда калиграфи таурс.',
