 ...
 */
class FloorB extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * Gets query for [[ApartmentsBs]].
     *
     * @return \yii\db\ActiveQuery
     */
    public function getApartmentsBs()
    {
        return $this->hasMany(ApartmentsB::className(), ['floor_num' => 'floor']);
    }
}
